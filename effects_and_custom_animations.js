...
// Lab 4--see 3
// Lab 5 -- add tweet to the top of the page, but make it fade in slowly. 
$(function() {
...
// Lab 6--delete all tweets slowly
$('#statuses').delegate('img.delete', 'click', function(){
	$(this).parent().fadeOut('slow', function() {
		$(this).remove();
	});
});
// Lab 7--resize text box slowly. 
$(function() {
...
// Lab 8b -- closes up white space above menu
// Lab 9 --accordion menu
